...
class Solution:
    def pathSum(self, root, targetSum: int):
        ...
        while len(queue):
            ...
            if front_node.left:
                queue.append([front_node.left,front_val+front_node.left.val])
                parent_dic[front_node.left] = front_node
            if front_node.right:
                queue.append([front_node.right,front_val+front_node.right.val])
                parent_dic[front_node.right] = front_node
            queue = queue[1:]
        return ans_list
